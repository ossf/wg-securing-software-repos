...
![A screenshot of a UI example of the highest level AAA requirements for visualising the sidebar content specifically](../images/highest-requirements-4.png "A screenshot of a UI example of the highest level AAA requirements for visualising the sidbar content specifcally")
